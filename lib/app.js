...
function openModal(evt) {
  ...
  evt.preventDefault();
  addClassListIsOpen();
  var bigSizePicture = evt.target.dataset.source;
  var altOnCurrentPicture = evt.srcElement.alt;
...
function slidePicturesToRight() {
  var src = document.querySelector('.lightbox__image').src;
  var newArr = galleryItems.map(function (item) {
    return item;
  });
